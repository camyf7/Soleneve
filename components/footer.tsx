        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-full bg-[#d41d51] flex items-center justify-center">
                <svg
                  viewBox="0 0 40 40"
                  className="w-8 h-8"
                  fill="none"
                ...
                >
                  <circle cx="20" cy="14" r="6" fill="#FFD700" />
                  <path
                    d="M8 28 C8 20 14 16 20 16 C26 16 32 20 32 28"
                    stroke="white"
                    strokeWidth="2.5"
                    fill="none"
                    strokeLinecap="round"
              ...
              <div>
                <div className="font-serif text-xl font-bold">Sol & Neve</div>
                <div className="text-[#FFD700] text-[10px] font-semibold tracking-[0.2em] uppercase">
                  Caraguatatuba
                </div>
              </div>
            </div>
